...
def start_listener():
    # listen for updates from greenhouse
...
@app.route("/")
def index():
    return render_template("index.html", state=greenhouse_state)


@app.route("/dashboard")
def dashboard():
    return render_template("dashboard.html", state=greenhouse_state)
